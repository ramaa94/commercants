...
<div id="main">
   ...
   <form action="updatecommission" method="POST">
        @csrf     
     </section>
     <div id="info-dossier">
      <section id="info-societe" class="sections">
        <label>Motif de commission:</label>
        <input type="text" name="commission_motif" value="{{$commission->commission_motif}}" > 
     </section>
     <section id="info-resp" class="sections">
        <label>Date de commission:</label>
        <input type="date" id="date-dossier" name="commission_date" value="{{$commission->commission_date}}> 
     </section>
    </div>
